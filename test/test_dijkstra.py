...
def test_dijkstra_classique():
    ...
    # affiche {1: (0, None), 2: (10, 1), 3: (40, 2)}
    print(graph.dijkstra_classique(1))
    # affiche {1: (inf, None), 2: (inf, None), 3: (0, None)}
    print(graph.dijkstra_classique(3))
...
def test_dijkstra_heap():
    ...
    # affiche {1: (0, None), 2: (10, 1), 3: (40, 2)}
    print(graph.dijkstra_heap(1))
    # affiche {1: (inf, None), 2: (inf, None), 3: (0, None)}
    print(graph.dijkstra_heap(3))
...
def test_dijkstra_comparatif():
    ...
    for i in range(50):
        ...
        assert [res_dijkstra_classique[i][0] for i in range(len(res_dijkstra_classique))] == [res_dijkstra_heap[i][0] for i in range(len(
            res_dijkstra_heap))], "Djikstra classique != Dijkstra heap directed graph \n" + str(res_dijkstra_classique) + "\n" + str(res_dijkstra_heap) + "\n" + str(graph1)
        del graph
    ...
    for i in range(50):
        ...
        assert [res_dijkstra_classique[i][0] for i in range(len(res_dijkstra_classique))] == [res_dijkstra_heap[i][0] for i in range(len(
            res_dijkstra_heap))], "Djikstra classique != Dijkstra heap undirected graph \n" + str(res_dijkstra_classique) + "\n" + str(res_dijkstra_heap) + "\n" + str(graph1)
        del graph
